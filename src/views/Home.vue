<template>
    <div>
        <v-container>
            <v-layout row>
                <v-flex xs2>
                    <svg data-name="\u56FE\u5C42 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 62 28"
                         fill="#de698c">
                        <defs></defs>
                ...
                <v-flex xs5>
                    <v-btn color="info" block round bottom>
                ...
                <v-flex xs1>
                    ...
                    <v-avatar size="1.7rem">
                        <v-img :src="require('../assets/img/icon.webp')"></v-img>
                    </v-avatar>
                </v-flex>
                <v-flex xs4 block>
                    <v-btn bottom color="error">下载APP</v-btn>
                </v-flex>
            </v-layout>
        </v-container>
        <v-container>
